package ru.javaops.bootjava.controller;
...
import ru.javaops.bootjava.exception.ExceptionApplication;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ExceptionApplication.class)
    public ProblemDetail appException(ExceptionApplication ex, WebRequest request) {
